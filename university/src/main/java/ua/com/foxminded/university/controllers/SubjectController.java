...
public class SubjectController {
	...
	String addNewSubjectToTeacher(@PathVariable(name = "teacherId") Long teacherId, SubjectWrapper subject,
			Model model) {
	...
	String deleteSubjectFromTeacher(@PathVariable(name = "teacherId") Long teacherId,
	...
	String showSubjectEditFormTeacherMode(@PathVariable(name = "subjectId") Long subjectId,
			@PathVariable(name = "teacherId") Long teacherId, Model model) {
	...
	String updateSubjectTeacherMode(@PathVariable(name = "subjectId") Long subjectId,
			@PathVariable(name = "teacherId") Long teacherId, Model model, SubjectWrapper subjectWrapper) {
