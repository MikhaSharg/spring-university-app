...
(7L,'2021-11-15', 1L, 1L, 1L, 1L, 1L),
(8L,'2021-11-15', 3L, 3L, 3L, 3L, 3L);

INSERT INTO archive_lectures (lecture_id, lecture_date, session_id, audience_id, subject_id, teacher_id, group_id, status, new_lecture_id) VALUES 
(2L,'2021-11-12', 2L, 2L, 2L, 2L, 2L, 'rescheduled to 20.11.2021', 6L);

INSERT INTO archive_lectures (lecture_id, lecture_date, session_id, audience_id, subject_id, teacher_id, group_id, status) VALUES 
(1L,'2021-11-11', 1L, 1L, 1L, 1L, 1L, 'canceled'),
(3L,'2021-11-13', 3L, 3L, 3L, 3L, 3L, 'edited audience to');
